...
//           console.log('<img className="detail-dog-not-found-img" src={noDog} alt="Dog not found img" /> :', <img className="detail-dog-not-found-img" src={noDog} alt="Dog not found img" />);
//           console.log('<img className="detail-dog-not-found-img" src={noDog} alt="Dog not found img" /> :', <img className="detail-dog-not-found-img" src={noDog} alt="Dog not found img" />);
//           console.log('<img className="detail-dog-not-found-img" src={noDog} alt="Dog not found img" /> :', <img className="detail-dog-not-found-img" src={noDog} alt="Dog not found img" />);
//           console.log('<img className="detail-dog-not-found-img" src={noDog} alt="Dog not found img" /> :', <img className="detail-dog-not-found-img" src={noDog} alt="Dog not found img" />);
//           console.log('<img className="detail-dog-not-found-img" src={noDog} alt="Dog not found img" /> :', <img className="detail-dog-not-found-img" src={noDog} alt="Dog not found img" />);
